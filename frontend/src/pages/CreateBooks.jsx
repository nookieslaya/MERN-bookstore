...
const CreateBooks = () => {
    ...
    return (
        <div className="p-4">
            ...
            {loading ? <Spinner/> : ''}
            <div className="flex flex-col border-2 border-sky-500 rounded-xl w-[600px] p4 mx-auto">
                ...
                <div className="my-4 p-2">
                    ...
                    <label className="text-xl mr-4 text-gray-50s">PublishYear</label>
                ...
                <button className="p-2 bg-sky-200" onClick={handleSaveBook}>Save</button>
            </div>
        </div>
    )
}
